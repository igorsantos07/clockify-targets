...
/**
 * Copied from https://dev.to/swiftwinds/comment/1o3lh
 */
...
async function fetchAndCache(request) {
	...
	try {
		...
		console.error('Issues caching this:', request)
		throw err
	}
}
...
worker.addEventListener('fetch', (event) => {
	...
	const isExternal          = event.request.url.startsWith('https://www.googletagmanager.com') //not sure why, but this was breaking

	if (isHttp && !isDevServerRequest && !skipBecauseUncached && !isExternal) {
		event.respondWith(
				(async () => {
